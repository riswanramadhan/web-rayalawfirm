...
export default function WhatsAppFloat() {
  ...
  return (
    <motion.a
      ...
      className="wa-float fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#25D366] px-4 py-3 text-white shadow-lg shadow-[#25D366]/40 hover:shadow-xl hover:shadow-[#25D366]/50 transition-shadow duration-300"
    >
